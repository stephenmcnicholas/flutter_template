...
**Files:**
- `lib/src/domain/repositories/auth_repository.dart` — abstract interface
...
- `lib/src/presentation/features/auth/` — login, signup, email verification screens
- `pubspec.yaml` dependencies: `firebase_auth`, `google_sign_in`

**Dependencies:** Firebase Core (always present)

**To remove this module:**
1. Delete `lib/src/domain/repositories/auth_repository.dart`
...
4. Delete `lib/src/presentation/features/auth/`
